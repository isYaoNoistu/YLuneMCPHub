          ...
          <div className="ylune-dialog-body">
            ...
            <div>
              <label className="ylune-label">
                {t('builtinResources.uri')} <span className="ylune-req">*</span>
              </label>
              <input
                type="text"
                value={uri}
            ...
            <div>
              <label className="ylune-label">{t('builtinResources.name')}</label>
              <input
                type="text"
                value={name}
            ...
            <div>
              <label className="ylune-label">{t('builtinResources.description')}</label>
              <input
                type="text"
                value={description}
            ...
            <div>
              <label className="ylune-label">{t('builtinResources.mimeType')}</label>
              <input
                type="text"
                value={mimeType}
            ...
            <div>
              <label className="ylune-label">
                {t('builtinResources.content')} <span className="ylune-req">*</span>
              </label>
              <textarea
                value={content}
    ...
    <div>
      <div className="hub-page-head">
        <div>
          ...
          <p className="hub-sub">
            <span className="hub-num">{resources.length}</span> {t('nav.resources')}
          </p>
        </div>
        {isAdmin && (
      ...
      {loading ? (
        ...
        <div className="hub-card">
          <div className="hub-empty">
            ...
            <p className="hub-empty-title">{t('builtinResources.noResources')}</p>
            {isAdmin && (
