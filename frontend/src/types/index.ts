...
export interface ActivityUsageBucket {
  name: string;
  count: number;
  errors: number;
}

export interface ActivityUsageDay {
  date: string;
  count: number;
  errors: number;
}

export interface ActivityUsageError {
  id: string;
  timestamp: string;
  tool: string;
  username?: string;
...
export interface ActivityUsage {
  ...
  tools: ActivityUsageBucket[];
  users: ActivityUsageBucket[];
  recentErrors: ActivityUsageError[];
}
